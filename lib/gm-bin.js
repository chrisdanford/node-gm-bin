...
var options = {
    ...
    url: 'https://github.com/404/', // intentional 404.  bin-check makes "url" required for all plaforms.  Dumb.
    ...
    platform: {
        darwin: {
            bin: 'osx/bin/gm',
            url: 'https://github.com/blank.txt' // Intentional 200 response.  This file is unused.
        },
        win32: {
            bin: 'win32/gm.exe',
            url: 'https://github.com/blank.txt' // Intentional 200 response.  This file is unused.
